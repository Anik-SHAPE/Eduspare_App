...
import { createNote, deleteNote, getAllContentByClassRoom, getAllNote, getContent, getNote, updateContent, updateNote } from '../helper/teacherapicall';
...
export default function MiniDrawer (props) {
  ...
  const handleDialogClose=()=>{
    ...
    contentLoad(user._id, token,user.classRoom, props.match.params.contentId);
    setopenDialog(false);
  }
          ...
          <div className="row">
            ...
            <div className="hideonmobile row ml-1 mr-2">
              ...
              <Card onClick={handleClick} className="shadow ml-2" style={{ borderRadius: 100, backgroundColor: "#ff6f00", width: 40, height: 40}} >
                <img className="d-block w-100 h-100 img-fluid" src={`${API}/get-ins-photo/${user.pannelID}`}/>
              </Card>
            </div>
