    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Grid container spacing="2" className="row">
          <Grid xs={12} sm={12} md={2} className="pl-2 pt-2">
            <Link to={`/institute/admin/more/postponed`} style={{textDecoration: "none"}}>
              <Card style={{borderRadius: 10, backgroundColor: "#fffff"}} className="pl-2 pr-2 pt-3">
                <center>
                    <img src={PendingLogo} style={{width: 60, height: 60}}/>
                    <p  className="pt-3" style={{fontSize: 20, fontWeight: "bold"}}>Pending Classes</p>
                </center>
              </Card>
            </Link>
