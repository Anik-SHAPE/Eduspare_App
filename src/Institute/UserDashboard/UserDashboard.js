...
import UsersDB from "./ManageUsers";
  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container spacing="1" className="mb-1">
        ...
        <Grid item xs={8} sm={6} md={6}>
          <div className="mt-3 row">
              <img src={InstituteLogo} style={{width: 40, height: 40}}/>
              <p className="pt-2 pl-2 pb-1" style={{color: "#000000", fontSize: 18}}>Institute Info</p>  
          </div>
        </Grid>
        <Grid item xs={2} sm={6} md={6}>
      ...
      <div className="ml-1 mr-2  row hideonmobile" style={{justifyContent: "space-between"}}>
          <Card className="pl-4 pr-4 shadow" style={{borderRadius: 15, backgroundColor: "#0091ea"}}><p className="my-auto p-1" style={{fontSize: 25, color: "#ffffff"}}>{instituteName}</p></Card>
            <Card className="pl-4 pr-4 shadow" style={{borderRadius: 15, backgroundColor: "#ffffff"}}>
              <div className="row">
                <Card className="shadow-sm my-auto mr-2" style={{ borderRadius: 100, width: 30, height: 30}} >
                  <img className="d-block w-100 h-100 img-fluid" src={InstituteLogo}/>
                </Card>
                <p className="my-auto p-1" style={{fontWeight: "bold", fontSize: 25, color: "#000000"}}>Institute Info</p>
              </div>
            </Card>
        </div>
        ...
        <div className="hidedesktop">
          <center>
            <Card className="pl-4 pr-4" style={{borderRadius: 15, backgroundColor: "#0091ea"}}><p className="my-auto p-1" style={{fontSize: 18, color: "#ffffff"}}>{instituteName}</p></Card>
          </center>
        </div>
