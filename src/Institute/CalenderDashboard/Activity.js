...
import { getAllBatch, getAllEventByScheduler,getAllEventsFromBatchs, getEvent } from '../helper/teacherapicall';
...
const BatchCalenderView=()=>{
  ...
  const Header = withStyles({ name: 'Header' })(({
    ...
    >
      ...
      >
      <Link to={`/institute/admin/calender/event/${appointmentData.batchId}/${appointmentData.contentId}/${appointmentData.eventId}`} style={{textDecoration: "none"}}>
