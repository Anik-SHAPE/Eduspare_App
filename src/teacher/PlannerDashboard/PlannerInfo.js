...
import {getPlanner,updatePlanner,getAllContentByClassRoom,getAllContentByPlanner,assignContentToPlanner,removeContentFromPlanner} from '../../Institute/helper/teacherapicall';
...
export default function MiniDrawer(props) {
  ...
  const assignContent=()=>{
   ...
   const getAllContent=()=>{
     getAllContentByTeacher(user._id, token, user.pannelID).then(data=>{
       if(data.error){
        console.log("error in db")
       }
       else{
