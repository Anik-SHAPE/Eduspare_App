...
import {createBatchPushToClass, getAllPlannerByClassRoom} from "../helper/teacherapicall";
import {getAllGrade, getAllSubject} from "../../admin/helper/adminapicall";
    ...
    <div>
      ...
      <Dialog onClose={handleClose}  fullWidth="true"  aria-labelledby="customized-dialog-title" open={open}>
        <DialogTitle id="customized-dialog-title" onClose={handleClose}>
          <p style={{fontFamily:"comic sans ms", fontSize: 25, fontWeight: "bold", color: "#00aeef" }}>Add Batch</p>
        </DialogTitle>
        <Divider/>
        <DialogContent>
        <form className={classes.root} noValidate autoComplete="off">
           <TextField className="mb-3" style={{width: "100%"}} type="text" id="text" label="Batch Name" variant="outlined" />
           ...
           <TextField className="mb-2" style={{width: "100%"}} type="text" id="text" label="Timing" variant="outlined" />
           <div className="form-group pt-2">
                <select className="form-control" placeholder="Category">
                    <option>Asign Teacher</option>
                    <option>Option 2</option>
                    <option>Option 3</option>
                    <option>Option 4</option>
                </select>
           </div>
           <button type="submit" className="nav-link mt-3 mb-2 mr-2 shadow btn" style={{borderRadius: 20, backgroundColor: "#00c853", color: "#ffffff", width: "100%"}}>Create Batch</button>
        </form>
        </DialogContent>
      </Dialog>
    </div>
