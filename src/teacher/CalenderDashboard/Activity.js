...
import { getAllBatch, getAllBatchByTeacher, getAllEventByScheduler,getAllEventsFromBatchs, getEvent, getTeacher } from '../helper/teacherapicall';
...
const BatchCalenderView=()=>{
  ...
  const Header = withStyles({ name: 'Header' })(({
    ...
    <AppointmentTooltip.Header
      {...restProps} appointmentData={cDate}
    >
       <Button color="secondary" style={{outline: "none"}}
       
        className={classes.commandButton}
      >
      <Link to={`/teacher/calender/event/${appointmentData.batchId}/${appointmentData.contentId}/${appointmentData.eventId}`} style={{textDecoration: "none"}}>
