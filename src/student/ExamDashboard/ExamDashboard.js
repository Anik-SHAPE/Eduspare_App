          ...
          <Grid container spacing="1" className="mb-1">
            ...
            <Grid item xs={8} sm={6} md={6}>
              <div className="mt-3 row">
                  <img src={ExamIcon} style={{width: 40, height: 40}}/>
                  <p className="pt-2 pl-2 pb-1" style={{color: "#000000", fontSize: 18}}>Exam</p>  
              </div>
            </Grid>
            <Grid item xs={2} sm={6} md={6}>
            ...
            <Card className="pl-4 pr-4 shadow" style={{borderRadius: 15, backgroundColor: "#ffffff"}}>
              <div className="row">
                <Card className="shadow-sm my-auto mr-2" style={{ borderRadius: 100, width: 30, height: 30}} >
                  <img className="d-block w-100 h-100 img-fluid" src={ExamIcon}/>
                </Card>
                <p className="my-auto p-1" style={{fontWeight: "bold", fontSize: 25, color: "#000000"}}>Exam</p>
              </div>
            </Card>
        </div>
