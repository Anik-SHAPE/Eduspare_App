  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
            ...
            <Card className="pl-4 pr-4 shadow" style={{borderRadius: 15, backgroundColor: "#ffffff"}}>
              <div className="row">
                <Card className="shadow-sm my-auto mr-2" style={{ borderRadius: 100, width: 30, height: 30}} >
                  <img className="d-block w-100 h-100 img-fluid" src={HomeworkLogo}/>
                </Card>
                <p className="my-auto p-1" style={{fontWeight: "bold", fontSize: 25, color: "#000000"}}>HomeWork</p>
              </div>
            </Card>
        </div>
          ...
          <Grid container spacing="1" className="mb-1">
            ...
            <Grid item xs={8} sm={6} md={6}>
              <div className="mt-3 row">
                  <img src={HomeworkLogo} style={{width: 40, height: 40}}/>
                  <p className="pt-2 pl-2 pb-1" style={{color: "#000000", fontSize: 18}}>HomeWork</p>  
              </div>
            </Grid>
            <Grid item xs={2} sm={6} md={6}>
        ...
        <Card className="shadow-sm d-block w-100 mb-2" style={{ backgroundColor: "#eceff1"}}>
          <Grid  container spacing="0">
            <Grid item xs={12} sm={12} md={12}>
              ...
              <p style={{fontSize: 20, fontFamily: "comic sans ms", color: "#039be5"}}>Topic : Topic Name</p></p>
              </Link> */}
              <p className="pt-3 pl-3" style={{fontSize: 16, fontWeight: "bold", color: "#000000"}}>Content Subject
              <p style={{fontSize: 20, fontFamily: "comic sans ms", color: "#039be5"}}>Topic : Topic Name</p></p>
            </Grid>
          </Grid>
        </Card>
