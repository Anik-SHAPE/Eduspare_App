...
const AddBatch = () => {
  ...
  return (
    <div>
      ...
      <Chip  style={{fontFamily: "comic sans ms", backgroundColor: '#00c853', color: '#ffffff'}} label="Add"/> 
      </Button>
      <Dialog onClose={handleClose}  fullWidth="true"  aria-labelledby="customized-dialog-title" open={open}>
        <DialogTitle id="customized-dialog-title" onClose={handleClose}>
          <p style={{fontFamily:"comic sans ms", fontSize: 25, fontWeight: "bold", color: "#00aeef" }}>Add Teacher</p>
        </DialogTitle>
        <Divider/>
        <DialogContent>
